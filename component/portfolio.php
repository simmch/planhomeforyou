...
<section id="portfolio" class="section portfolio-sec portfolio-filter">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3 col-sm-6 pad0">
                <div class="element-item box" data-aos="fade-up">
                    <img src="assets/img/des-port1.jpg" alt="">
                    <div class="box-content">
                        <a href="assets/img/des-port1.jpg" class="popup-link"><i class="ion-plus"></i></a>
            ...
            <div class="col-md-3 col-sm-6 pad0">
                <div class="element-item box" data-aos="fade-up" >
                    <img src="assets/img/des-port6.jpg" alt="">
                    <div class="box-content">
                        <a href="assets/img/des-port6.jpg" class="popup-link"><i class="ion-plus"></i></a>
                        <h3 class="title">CATALOGUE ILLUSTRATOR</h3>
                    </div>
                </div>
            </div>
